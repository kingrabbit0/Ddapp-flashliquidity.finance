...
const SBP = () => {
  ...
  return (
    <div className="relative lg:mr-36 bg-secondary-gradient pb-8 top-2" style={{ borderRadius: '3rem', border: '2px solid #1a1a3a'}}>
      <div className="relative z-10 mt-4 flex items-center mx-auto sm:mt-12 sm:flex-col-reverse md:flex-col-reverse md:mt-12 sm:px-9 md:px-9 sm:w-full md:w-full">
        ...
        <div className="text-white z-10 ml-7 pt-2 sm:ml-0 sm:text-center md:mr-7">
          ...
          }} className="text-42 text-white gotham_font_bold pt-6 mb-2.5 sm:text-4xl sm:mb-3 md:text-4xl md:text-center xs:text-2xl">Self-balancing pools</h1>
