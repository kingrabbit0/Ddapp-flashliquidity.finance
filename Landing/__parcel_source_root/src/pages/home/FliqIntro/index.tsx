...
export const FliqIntro = () => {
  return (
    <div style={{ borderRadius: '3rem', border: '2px solid #1a1a3a' }} className="relative bg-secondary-gradient lg:pb-12 mt-24 lg:ml-36">
        ...
        <div className="lg:w-full sm:w-full md:w-full flex flex-col">
          ...
          <div className="flex items-center sm:hidden md:hidden">
            <button
              ...
              onClick={() => {
                window.open('https://docs.flashliquidity.finance/ecosystem/fliq-token', '_blank');
              }}
            >
              View docs
              <span className="ml-3">
