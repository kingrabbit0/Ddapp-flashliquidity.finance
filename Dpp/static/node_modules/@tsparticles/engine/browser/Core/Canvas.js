    ...
    this._applyPreDrawUpdaters = (
      ...
      for (const updater of this._preDrawUpdaters) {
        if (updater.getColorStyles) {
          const { fill, stroke } = updater.getColorStyles(
            particle,
            ctx,
            radius,
            zOpacity
    ...
    this._setFullScreenStyle = () => {
      ...
      setStyle(
        element,
        {
          position: "fixed",
          zIndex:
            this.container.actualOptions.fullScreen.zIndex.toString(radix),
          top: "0",
          left: "0",
          width: "100%",
          height: "100%",
  ...
  drawParticle(particle, delta) {
    ...
    this.draw((ctx) => {
      const container = this.container,
        ...
        defaultOpacity = 1,
        opacity =
          particle.bubble.opacity ?? particle.opacity?.value ?? defaultOpacity,
