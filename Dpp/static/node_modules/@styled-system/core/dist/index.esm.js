...
export var merge = function merge(a, b) {
  ...
  for (var key in a) {
    ...
    assign(
      result,
      ((_assign = {}), (_assign[key] = assign(a[key], b[key])), _assign)
    );
  }
  ...
  raw.slice(0, mediaQueries.length).forEach(function (value, i) {
    ...
    if (!media) {
      ...
      assign(
        styles,
        ((_assign2 = {}),
        (_assign2[media] = assign({}, styles[media], style)),
        _assign2)
      );
    }
  });
  ...
  for (var key in raw) {
    ...
    if (!breakpoint) {
      ...
      assign(
        styles,
        ((_assign3 = {}),
        (_assign3[media] = assign({}, styles[media], style)),
        _assign3)
      );
    }
  }
...
export var compose = function compose() {
  ...
  for (
    var _len = arguments.length, parsers = new Array(_len), _key = 0;
    _key < _len;
    _key++
  ) {
