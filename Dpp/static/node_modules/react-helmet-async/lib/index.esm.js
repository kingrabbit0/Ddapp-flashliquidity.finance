...
var getBaseTagFromPropsList = (primaryAttributes, propsList) =>
  propsList
    .filter((props) => typeof props["base" /* BASE */] !== "undefined")
    .map((props) => props["base" /* BASE */])
    .reverse()
        ...
        .filter((tag) => {
          ...
          for (let i = 0; i < keys2.length; i += 1) {
            ...
            if (
              primaryAttributes.indexOf(lowerCaseAttributeKey) !== -1 &&
              !(
                primaryAttributeKey === "rel" /* REL */ &&
                tag[primaryAttributeKey].toLowerCase() === "canonical"
              ) &&
              !(
                lowerCaseAttributeKey === "rel" /* REL */ &&
            ...
            if (
              ...
              (attributeKey === "innerHTML" /* INNER_HTML */ ||
                attributeKey === "cssText" /* CSS_TEXT */ ||
                attributeKey === "itemprop") /* ITEM_PROP */
            ) {
    ...
    const attributeHtml = Object.keys(tag)
      .filter(
        (attribute) =>
          !(
            (
              attribute === "innerHTML" /* INNER_HTML */ ||
              attribute === "cssText"
            ) /* CSS_TEXT */
          )
      )
...
var generateTagsAsReactComponent = (type, tags) =>
  tags.map((tag, i) => {
    ...
    Object.keys(tag).forEach((attribute) => {
      ...
      if (
        mappedAttribute === "innerHTML" /* INNER_HTML */ ||
        mappedAttribute === "cssText" /* CSS_TEXT */
      ) {
...
var updateTags = (type, tags) => {
  const headElement =
    document.head || document.querySelector("head" /* HEAD */);
...
var Helmet = class extends Component3 {
  ...
  render() {
    ...
    return helmetData
      ? /* @__PURE__ */ React3.createElement(HelmetDispatcher, {
          ...newProps,
