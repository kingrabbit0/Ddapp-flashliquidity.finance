...
export function useTranslation(ns) {
  ...
  var _props$useSuspense = props.useSuspense,
    useSuspense =
      _props$useSuspense === void 0
        ? i18nOptions.useSuspense
        : _props$useSuspense; // prepare having a namespace
  ...
  namespaces =
    typeof namespaces === "string"
      ? [namespaces]
      : namespaces || ["translation"]; // report namespaces as used

  if (i18n.reportNamespaces.addUsedNamespaces)
    i18n.reportNamespaces.addUsedNamespaces(namespaces); // are we ready? yes if all namespaces in first language are loaded already (either with data or empty object on failed load)
  ...
  useEffect(
    ...
    [namespaces.join()]
  ); // re-run effect whenever list of namespaces changes
